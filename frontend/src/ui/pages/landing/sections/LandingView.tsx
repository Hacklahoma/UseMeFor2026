...
const LandingView: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-full flex items-center justify-center px-6">
          ...
          <nav className="hidden min-[600px]:flex items-center">
            ...
            <div className="ml-12 lg:ml-16 xl:ml-20 2xl:ml-24">
              <a
                href="#"
                className="text-[#3D472C] hover:text-[#2a3a1f] transition-colors font-medium"
              >
                Login
              </a>
            </div>
        ...
        >
          <nav className="flex flex-col py-4 items-center">
            <a
              href="#top"
              className="px-6 py-3 text-[#3D472C] hover:bg-[#e8e8c7] transition-colors"
            >
              Home
            </a>
            <a
            ...
            <a
              href="#"
              className="px-6 py-3 text-[#3D472C] hover:bg-[#e8e8c7] transition-colors font-medium"
            >
              Login
            </a>
          </nav>
      ...
      <div
        className={`fixed top-0 right-8 z-[60] transition-opacity duration-1000 ease-in-out ${
          showFinalElements ? "opacity-100" : "opacity-0"
        }`}
      >
        <a
      ...
      <div
        className={`absolute bottom-8 left-8 lg:bottom-12 lg:left-12 transition-opacity duration-1000 ease-in-out ${
          showFinalElements ? "opacity-100" : "opacity-0"
        }`}
      >
