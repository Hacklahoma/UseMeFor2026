...
const About: React.FC = () => {
  return (
    <section
      id="about"
      className="h-screen w-full min-w-[380px] bg-[#F5F5DC] flex items-center justify-center px-6"
    >
      <div className="max-w-5xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold text-[#3D472C] text-center">
          Hacklahoma
        </h2>
