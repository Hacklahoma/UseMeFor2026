...
const Letters: Letter[] = [
    {
        id:"H",
        src: LetterH,
        className: "left-[13%] top-[36%] rotate-[-8deg]",

    },
    {
        id:"A",
        src: LetterA,
        className: "left-[26%] top-[37%] rotate-[4deg]",
    },
    {
        id:"C",
        src: LetterC,
        className: "left-[40%] top-[36%] rotate-[-3deg]",
    },
    {
        id:"K",
        src: LetterK,
        className: "left-[56%] top-[37%] rotate-[2deg]",
    },
    {
        id:"E",
        src: LetterE,
        className: "left-[70%] top-[36%] rotate-[-1deg]",
    },
    {
        id:"R",
        src: LetterR,
        className: "left-[83%] top-[37%] rotate-[1deg]",
    },
    {
        id: "G",
        src: LetterG,
        className: "left-[20%] top-[51%] rotate-[5deg]",
    },
    {
        id:"U",
        src: LetterU,
        className: "left-[36%] top-[52%] rotate-[5deg]",
    },
    {
        id:"I",
        src: LetterI,
        className: "left-[53%] top-[51%] rotate-[5deg]",
    },
    {
        id:"D",
        src: LetterD,
        className: "left-[60%] top-[51%] rotate-[5deg]",
    },
    {
        id:"E2",
        src: LetterE2,
        className: "left-[72%] top-[51%] rotate-[5deg]",
    },
];
